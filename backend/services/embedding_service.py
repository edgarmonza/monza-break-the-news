"""
Servicio de embeddings usando Google Gemini (gemini-embedding-001)
Free tier: 1500 requests/min — more than enough for our pipeline.
"""
...
class EmbeddingService:
    """Servicio para generar embeddings de artículos usando Google Gemini"""
    ...
    async def embed_text(self, text: str) -> Optional[List[float]]:
        ...
        try:
            ...
            # google-genai SDK is sync, run in thread to avoid blocking
    ...
    async def embed_query(self, query: str) -> Optional[List[float]]:
        """Genera embedding para una query de búsqueda (RAG / semantic search)"""
